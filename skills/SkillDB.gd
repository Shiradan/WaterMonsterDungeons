...
func _initialize():
	...
	#固定治疗数值（非必要）
	add_valid_property("HealValue",TYPE_INT)
	#治疗骰子面数（非必要）
	add_valid_property("HealDice",TYPE_INT)
	#治疗骰子数（非必要）
	add_valid_property("HealDiceNo",TYPE_INT)
	...
	add_valid_property("Duration",TYPE_INT)
